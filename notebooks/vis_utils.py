...
def plot_time_series(data, targets=None, channel_titles=None, figsize_per_subplot=(5, 3)):
    """
    Plot multiple time series side by side in a grid, each scaled to its own min and max values, with optional target time series.
